...
- [ ] 01-01-PLAN.md — Walking Skeleton vertical slice: engine + Claude adapter + config + CLI render-multi-row + first-run init [wave 1]
...
| 1. Engine + Claude + TUI Scaffold | 0/3 | Planned | - |
